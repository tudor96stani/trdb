use crate::page::behavior::insertion_plan::{InsertionOffset, InsertionPlan, InsertionSlot};
use crate::page::errors::InsertError;
...
impl Page {
    ...
    pub fn plan_insert_internal(&self, row_len: usize) -> Result<InsertionPlan, InsertError> {

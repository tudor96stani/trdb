...
use crate::page::errors::DeleteError;
use crate::page::errors::SlotError;
use crate::page::layout::page::Page;

impl Page {
    pub(crate) fn delete_row_internal(
        &mut self,
        slot_index: usize,
    ...
    fn try_to_find_new_free_start(
        ...
        // Also store the slot info for the row at the 2nd to the highest offset in the page. The end of this row will become the new free_start

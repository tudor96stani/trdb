...
use crate::page::errors::SlotError;
use crate::page::layout::page::Page;
use crate::page::layout::slot::{SLOT_SIZE, SlotRef};
use crate::page::layout::slot_array::{SlotArrayMut, SlotArrayRef};
...
impl Page {
    ...
    #[inline]
    pub fn slot_array_ref(&'_ self) -> Result<SlotArrayRef<'_>, SlotError> {
    ...
    pub fn slot_array_mut(&'_ mut self) -> Result<SlotArrayMut<'_>, SlotError> {
        let free_end_offset = self.header_ref()?.get_free_end()? as usize;
        let slot_count = self.header_ref()?.get_slot_count()?;
    ...
    #[inline]
    pub fn row_size_fits(&self, row_size: usize) -> Result<bool, HeaderError> {
    ...
    pub fn is_slot_valid(&self, slot: &SlotRef) -> Result<bool, SlotError> {
...
mod private_methods_tests {
    ...
    fn slot_array_corrupted_header_returns_error() {
        ...
        let _ = page.header_mut().unwrap().set_free_end(4090);
        let _ = page.header_mut().unwrap().set_slot_count(10);
